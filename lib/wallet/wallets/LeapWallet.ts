...
import { kopiExperimentalSuggestChain } from '../../utils/kopiExperimentalSuggestChain';
...
export class LeapWallet implements AbstractWallet {
    ...
    async getAccounts(): Promise<Account[]> {
        ...
        // @ts-ignore
        if (
            this.chainId == 'luwak-1' ||
            this.chainId == 'kopi-dev-1' ||
            this.chainId == 'kopi-test-5'
        ) {
            let chainName = {
                'luwak-1': 'kopi',
                'kopi-dev-1': 'kopi devnet',
                'kopi-test-5': 'kopi testnet',
            };
            let chainData = kopiExperimentalSuggestChain(
                this?.chainId,
